...
/**
 ...
 \return none
 */
void lcd_putchar(char value);			//-	Put char to cursor position
...
/**
 ...
 \retval false if not successfull
 */
bool lcd_putcharlr(unsigned char line, unsigned char row, char value);	//-	Put char to position
...
/**
 ...
 \retval false if not successfull
 */
bool lcd_printlr(unsigned char line, unsigned char row , char *string);	//-	Print string to position
...
/**
 ...
 \retval false if not successfull
 */
bool lcd_printlc(unsigned char line, unsigned char row, char *string);		//-	Print string to position 
...
/**
 ...
 \retval false if not successfull
 */
bool lcd_printlrc(unsigned char line, unsigned char row, char *string);	//-	Print string to position 
											//-	(If string is longer than LCD_ROWS
