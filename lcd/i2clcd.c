...
bool lcd_printlc(unsigned char line, unsigned char row, char *string)
{
	unsigned char i;
...
bool lcd_printlrc(unsigned char line, unsigned char row, char *string)
{
	unsigned char i;
...
bool lcd_printlr(unsigned char line, unsigned char row, char *string)
{
	if(!lcd_gotolr(line, row)) return false;
	lcd_print(string);
